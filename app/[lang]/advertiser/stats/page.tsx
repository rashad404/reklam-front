        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: BarChart3, label: t('advertiser.spent'), value: `${data.totals.total_spent} AZN`, color: 'text-orange-600', bg: 'bg-orange-100 dark:bg-orange-900/30' },
            ].map((stat, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* By Device */}
            <div className="card">
              <h2 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">{t('advertiser.impressions')} - Device</h2>
            ...
            {/* By Country */}
            <div className="card">
              <h2 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">{t('advertiser.impressions')} - Country</h2>
              <div className="space-y-3">
          ...
          {data.by_campaign && data.by_campaign.length > 0 && (
            <div className="card">
              <h2 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">{t('advertiser.campaigns')}</h2>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-left text-gray-500 border-b border-gray-200 dark:border-gray-700">
                      <th className="pb-2 font-medium">{t('advertiser.campaignName')}</th>
          ...
          {data.by_browser && data.by_browser.length > 0 && (
            <div className="card">
              <h2 className="text-sm font-semibold text-gray-900 dark:text-white mb-4">Browser</h2>
