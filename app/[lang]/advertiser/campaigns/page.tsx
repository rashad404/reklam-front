...
import { Plus, Eye, MousePointer, Play, Pause, DollarSign, Image as ImageIcon, Pencil, BarChart3 } from 'lucide-react';
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Link
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-400 transition-colors"
                      >
